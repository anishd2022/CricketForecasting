...
(continue to improve this section as I understand more)
...
For each model, we computed predictions for the test set across 14 activation gates $mtotal = 14$, and recorded the RMSE at each depth. The best configuration achieved a test-set \( R^2 \) of approximately 0.953, outperforming models such as random forests. 
...
- The mactivate model achieved an $R^2$ of 0.8754 when predicting the final score at 20 overs from an intervention point of 10 overs, and achieved an $R^2$ of 0.9523 when predicting over 20 score from over 15. 
